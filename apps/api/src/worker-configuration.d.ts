/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 569feb82e5438011df8d18202908c920)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "https://staging.jba-greengold-orchard.pages.dev,https://staging.jbagreengoldorchard.farm" | "https://jbagreengoldorchard.farm,https://www.jbagreengoldorchard.farm" | "http://localhost:5173,http://localhost:8788";
	PASSWORD_RESET_URL: "https://staging.jba-greengold-orchard.pages.dev/reset-password" | "https://jbagreengoldorchard.farm/reset-password" | "http://localhost:5173/reset-password";
	EMAIL_FROM: "JBA GreenGold Orchard <noreply@jbagreengoldorchard.farm>";
	DATABASE_URL: string;
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		CF_VERSION_METADATA: WorkerVersionMetadata;
		APP_ENV: "staging";
		ALLOWED_ORIGINS: "https://staging.jba-greengold-orchard.pages.dev,https://staging.jbagreengoldorchard.farm";
		PASSWORD_RESET_URL: "https://staging.jba-greengold-orchard.pages.dev/reset-password";
		EMAIL_FROM: "JBA GreenGold Orchard <noreply@jbagreengoldorchard.farm>";
		DATABASE_URL: string;
		CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE: string;
	}
	interface ProductionEnv {
		...
		CF_VERSION_METADATA: WorkerVersionMetadata;
		APP_ENV: "production";
		ALLOWED_ORIGINS: "https://jbagreengoldorchard.farm,https://www.jbagreengoldorchard.farm";
		PASSWORD_RESET_URL: "https://jbagreengoldorchard.farm/reset-password";
		EMAIL_FROM: "JBA GreenGold Orchard <noreply@jbagreengoldorchard.farm>";
		DATABASE_URL: string;
		CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ALLOWED_ORIGINS" | "PASSWORD_RESET_URL" | "EMAIL_FROM" | "DATABASE_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE">> {}
}
