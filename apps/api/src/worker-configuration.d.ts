/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 00fe97025fec9e1942be6dc2d6d16574)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "https://staging.jbagreengoldorchard.farm" | "https://jbagreengoldorchard.farm,https://www.jbagreengoldorchard.farm" | "http://localhost:5173,http://localhost:8788";
	PASSWORD_RESET_URL: "https://staging.jbagreengoldorchard.farm/reset-password" | "https://jbagreengoldorchard.farm/reset-password" | "http://localhost:5173/reset-password";
...
declare namespace Cloudflare {
	interface StagingEnv {
		...
		HYPERDRIVE: Hyperdrive;
		APP_ENV: "staging";
		ALLOWED_ORIGINS: "https://staging.jbagreengoldorchard.farm";
		PASSWORD_RESET_URL: "https://staging.jbagreengoldorchard.farm/reset-password";
		EMAIL_FROM: "JBA GreenGold Orchard <noreply@jbagreengoldorchard.farm>";
		DATABASE_URL: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ALLOWED_ORIGINS" | "PASSWORD_RESET_URL" | "EMAIL_FROM" | "DATABASE_URL">> {}
}
