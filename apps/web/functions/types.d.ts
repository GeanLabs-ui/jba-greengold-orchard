/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/web/wrangler.jsonc apps/web/functions/types.d.ts` (hash: bec422b1d6224f879b06b00a8d6c810f)
// Runtime types generated with workerd@1.20260721.1 2026-07-22 nodejs_compat
interface __BaseEnv_Env {
	APP_ENV?: "staging" | "production";
	API: Fetcher /* mango-farm-api-staging */ | Fetcher /* mango-farm-api-production */;
}
declare namespace Cloudflare {
	interface PreviewEnv {
		APP_ENV: "staging";
		API: Fetcher /* mango-farm-api-staging */;
	}
	interface ProductionEnv {
		APP_ENV: "production";
		API: Fetcher /* mango-farm-api-production */;
	}
