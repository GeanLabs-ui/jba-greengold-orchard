...
export default function Terms() {
  return (
    <div className="platform-page platform-reading bg-background py-16">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 space-y-8 text-sm leading-7 text-foreground">
          <section>
            <h2 className="text-section-title">1. Acceptance</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-section-title">2. Use of the Platform</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-section-title">3. Orders and Payments</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-section-title">4. Intellectual Property</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-section-title">5. Limitation of Liability</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-section-title">6. Governing Law</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-section-title">7. Changes to Terms</h2>
            <p className="mt-3">
