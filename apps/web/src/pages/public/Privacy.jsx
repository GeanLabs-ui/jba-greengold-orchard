    ...
    <div className="platform-page platform-reading bg-background py-16">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 space-y-8 text-sm leading-7 text-foreground">
          <section>
            <h2 className="text-section-title">1. Information We Collect</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-section-title">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-section-title">3. Data Sharing</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-section-title">4. Cookies and Tracking</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-section-title">5. Data Retention</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-section-title">6. Your Rights</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-section-title">7. Security</h2>
            <p className="mt-3">
