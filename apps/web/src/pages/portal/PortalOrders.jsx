  ...
  return (
    <div>
      <PageHeader title="My Orders" description="Track your orders and delivery status.">
        <Link to="/portal/tracking" className="platform-action inline-flex h-10 items-center rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground hover:bg-primary/90">Open detailed tracking <ArrowRight className="ml-2 h-4 w-4" /></Link>
      </PageHeader>
