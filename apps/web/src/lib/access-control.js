...
export const ADMIN_PAGE_ACCESS = [
  ...
  { key: 'crm', label: 'CRM', path: '/admin/crm', group: 'Operations' },
  { key: 'inquiries', label: 'Client Inquiries', path: '/admin/inquiries', group: 'Operations' },
  { key: 'sales', label: 'Sales', path: '/admin/sales', group: 'Operations' },
  { key: 'orders', label: 'Orders', path: '/admin/orders', group: 'Operations' },
  { key: 'inventory', label: 'Inventory', path: '/admin/inventory', group: 'Operations' },
  { key: 'logistics', label: 'Logistics', path: '/admin/logistics', group: 'Operations' },
  ...
  { key: 'hr', label: 'Human Resources', path: '/admin/hr', group: 'Business' },
  { key: 'applications', label: 'Applications ATS', path: '/admin/applications', group: 'Business' },
