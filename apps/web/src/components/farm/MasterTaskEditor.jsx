...
import { BarChart3, CalendarDays, ClipboardList, Clock3, FileText, Flag, House, ListTodo, MessageCircle, Pencil, Plus, Save, Timer, Trash2, UsersRound } from 'lucide-react';
    ...
    <Dialog open onOpenChange={(open) => !open && !saving && onClose()}>
      <DialogContent className="master-task-editor" aria-describedby={undefined} data-preserve-colors="true" onInteractOutside={(event) => event.preventDefault()} onEscapeKeyDown={(event) => saving && event.preventDefault()}>
        <header className="mte-header">
          <div className="mte-brand"><img src="/brand/header-logo-reference.webp" alt="JBA GreenGold Orchard" /></div>
