      ...
      <Sheet open={mobileSearchOpen} onOpenChange={setMobileSearchOpen}>
        <SheetContent side="bottom" className="max-h-[82dvh] rounded-t-2xl px-4 pb-[max(1.25rem,env(safe-area-inset-bottom))] pt-7 md:hidden">
          ...
          <form onSubmit={runSearch} className="mt-4">
            <label className="relative block text-label">
              <Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
      ...
      <Dialog open={profileOpen} onOpenChange={setProfileOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <form onSubmit={saveProfile} className="space-y-4">
            <div>
              <Label className="text-label" htmlFor="profile-full-name">Display name</Label>
            ...
            <div>
              <Label className="text-label" htmlFor="profile-email">Email</Label>
