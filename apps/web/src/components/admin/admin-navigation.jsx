...
export const adminNavSections = [
  ...
  },
  {
    ...
    icon: Users,
    items: [
      { label: 'Client Management', path: '/admin/client-management', icon: Users, countKey: 'inquiries' },
      { label: 'Marketing', path: '/admin/marketing', icon: ShoppingCart, countKey: 'orders' },
