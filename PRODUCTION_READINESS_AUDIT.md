...
| 7 | Git and version control | Configured | Branch policy, CODEOWNERS, pull request template, Dependabot, protected-environment guidance, and feature/staging/main flow exist. |
