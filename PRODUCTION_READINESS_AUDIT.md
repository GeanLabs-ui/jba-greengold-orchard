...
| 3 | Database and storage | Code ready; resources blocked | Neon/Postgres migrations are checksum-locked. Files are private, dual-written to environment-specific primary/backup R2 bindings, and recover from backup on a missing primary object. R2 is not yet enabled in the live Cloudflare account. |
